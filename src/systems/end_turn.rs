...
pub fn end_turn(sub_world: &SubWorld, #[resource] turn_state: &mut TurnState, #[resource] map: &Map) {
    ...
    let amulet_pos = amulet_yala_pos.iter(sub_world).nth(0).unwrap_or(&default_pos);
